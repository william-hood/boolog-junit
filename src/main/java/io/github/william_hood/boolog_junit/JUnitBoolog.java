package io.github.william_hood.boolog_junit;

import io.github.william_hood.boolog_java.Constants;
import io.github.william_hood.boolog_java.HeaderFunction;
...
public class JUnitBoolog extends io.github.william_hood.boolog_java.Boolog {
    public enum Status { PASSING, INCONCLUSIVE, FAILING, UNSET };

    /**
     * Reflect the color coding of this Boolog, when embedded in another Boolog such as
    ...
    /**
     * The color coding of this Boolog, when embedded in another Boolog such as
     * a top-level or higher level log, is determined by its status. PASSING ->
     * Green; FAILING -> Red; INCONCLUSIVE or UNSET -> Yellow. When an assertion
     * through this Boolog instance is carried out, it reports its status via
     ...
     * FAILING and this Boolog can no longer become Passing unless the programmer
     * forces it via the 'status' field. If an assumption fails, the status
     * becomes INCONCLUSIVE. Again this Boolog's status can not become Passing
    ...
    /**
     * Primary constructor for the JUnit extended Boolog Java Wrapper. This contains a Kotlin Boolog but does not extend it nor expose it in any way.
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that assumes showing emojis and timestamps, no headerFunction and no output for plain text or HTML.
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that uses the title "(unknown)".
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that assumes showing timestamps and emojis but no header function and no HTML or plain text output.
     * This contains a Kotlin Boolog but does not extend it nor expose it in any way.
     * Boolog is a logging system designed to produce rich, readable HTML-based output with appropriate
     * console output accompanying it. A Boolog may be a root-level log file, a subsection of another Boolog, or both.
     * It includes methods to render objects, HTTP transactions, exceptions, collections and other Boologs
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that assumes showing timestamps and emojis but no HTML or plain text output.
     * This contains a Kotlin Boolog but does not extend it nor expose it in any way.
     * Boolog is a logging system designed to produce rich, readable HTML-based output with appropriate
     * console output accompanying it. A Boolog may be a root-level log file, a subsection of another Boolog, or both.
     * It includes methods to render objects, HTTP transactions, exceptions, collections and other Boologs
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that assumes no plaintext or HTML output and no header function.
     * This contains a Kotlin Boolog but does not extend it nor expose it in any way.
     * Boolog is a logging system designed to produce rich, readable HTML-based output with appropriate
     * console output accompanying it. A Boolog may be a root-level log file, a subsection of another Boolog, or both.
     * It includes methods to render objects, HTTP transactions, exceptions, collections and other Boologs
    ...
    /**
     * Alternate constructor for the JUnit extended Boolog Java Wrapper that assumes no plaintext or HTML output.
     * This contains a Kotlin Boolog but does not extend it nor expose it in any way.
     * Boolog is a logging system designed to produce rich, readable HTML-based output with appropriate
     * console output accompanying it. A Boolog may be a root-level log file, a subsection of another Boolog, or both.
     * It includes methods to render objects, HTTP transactions, exceptions, collections and other Boologs
    ...
    /**
     * Use this function to embed another JUnitBoolog within this one. The embedded
     * JUnitBoolog will be color coded according to its status.
     * @param subordinate The JUnitBoolog you wish to embed in this one. The subordinate
     *                    JUnitBoolog will be concluded once you embed it and it
     *                    will no lnge rbe possible to write to it.
     * @return Returns HTML text representing the embedded JUnitBoolog. Ignore
     * the return value unless you know what you're doing and why.
     */
    public String showJUnitBoolog(JUnitBoolog subordinate) {
        String style;
        String emoji;
        ...
        return showBoolog(subordinate, emoji, style);
    }
     ...
     * with the given exception as the cause. Boolog will display the
